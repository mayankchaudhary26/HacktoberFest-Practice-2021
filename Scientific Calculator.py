...
btnClear = Button(calc, text=chr(67),width=6, height=2,bg='powder blue', font=('Helvetica',20,'bold')
                  ,bd=4, command=added_value.Clear_Entry).grid(row=1, column= 0, pady = 1)

btnAllClear = Button(calc, text=chr(67)+chr(69),width=6, height=2,bg='powder blue', font=('Helvetica'
...
btnPi = Button(calc, text="π",width=6, height=2,bg='black',fg='white', font=('Helvetica',20,'bold'),
...
btn2Pi = Button(calc, text="2π",width=6, height=2,bg='black',fg='white', font=('Helvetica',20,'bold'),
