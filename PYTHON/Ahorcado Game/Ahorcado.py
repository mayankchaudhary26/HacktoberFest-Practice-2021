"""
This is a little improvement of a classic Word Guesser game. 
This game is called AHORCADO GAME, and it can take a file with 
a single word for each row as a list of words for the game.
